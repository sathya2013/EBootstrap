...
package com.me.bootstrap.shiro;
...
import com.me.bootstrap.util.Digests;
import com.me.bootstrap.util.Encodes;
...
public class ShiroDbRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		shiroUser.getUser().setUserRoles(new HashSet(userRoles));
