				...
				<div class="well span5 center login-box">
					...
					<form class="form-horizontal" action="${ctx}/login" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="ValidateCode" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input type="text" id="captcha_key" name="captcha_key"  />
