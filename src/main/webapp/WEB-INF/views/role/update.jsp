    ...
    <div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 编辑角色表单</h2>
						<div class="box-icon">
							...
							<fieldset>
							  <div class="control-group">
								...
								<div class="controls">
								  ...
								  <input class="input-xlarge focused" id="name" name="name" type="text" value="${role.name}">
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="description" name="description" type="text" value="${role.description}">
								</div>
							  </div>
